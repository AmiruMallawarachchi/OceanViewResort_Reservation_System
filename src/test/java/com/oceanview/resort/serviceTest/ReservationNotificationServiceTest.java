...
/**
 * Tests for ReservationNotificationService interface contract (via ReservationNotificationServiceImpl).
 */
...
public class ReservationNotificationServiceTest {
    ...
    public void setup() throws Exception {
        ...
        Field propsField = com.oceanview.resort.config.AppConfig.class.getDeclaredField("PROPERTIES");
    ...
    @Test
    public void publishConfirmation_buildsEventAndSendsNotification() {
    ...
    @Test
    public void publishCancellation_buildsEventWithCancelledStatus() {
    ...
    @Test
    public void publishConfirmation_nullReservation_stillSendsEvent() {
        try (MockedStatic<com.oceanview.resort.messaging.KafkaEventProducer> kafka =
                     mockStatic(com.oceanview.resort.messaging.KafkaEventProducer.class)) {
