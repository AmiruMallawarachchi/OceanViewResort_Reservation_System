...
<%@ page import="java.util.List,com.oceanview.resort.dto.GuestDTO,com.oceanview.resort.util.HtmlUtil" %>
      ...
      <div class="panel">
        ...
        <form class="form" method="post" action="<%= ctx %>/guests">
          ...
          <div class="form__group">
            ...
            <input type="text" name="fullName" placeholder="Guest full name" value="<%= isEdit ? HtmlUtil.escape(editGuest.getFullName()) : "" %>" class="<%= fieldErrors != null && fieldErrors.get("fullName") != null ? "input--error" : "" %>" required />
            <%
          ...
          <div class="form__group">
            <label>Email</label>
            <input type="email" name="email" placeholder="guest@email.com" value="<%= isEdit ? (editGuest.getEmail() == null ? "" : HtmlUtil.escape(editGuest.getEmail())) : "" %>" />
          </div>
          <div class="form__group">
            <label>Phone</label>
            <input type="text" name="phone" placeholder="+94 7X XXX XXXX" value="<%= isEdit ? HtmlUtil.escape(editGuest.getPhone()) : "" %>" class="<%= fieldErrors != null && fieldErrors.get("phone") != null ? "input--error" : "" %>" required />
            <%
              if (fieldErrors != null && fieldErrors.get("phone") != null) {
            %>
            <div class="form__error"><%= HtmlUtil.escape(fieldErrors.get("phone")) %></div>
            <%
              }
            %>
          </div>
          <div class="form__group">
            <label>Address</label>
            <input type="text" name="address" placeholder="Full address" value="<%= isEdit ? HtmlUtil.escape(editGuest.getAddress()) : "" %>" class="<%= fieldErrors != null && fieldErrors.get("address") != null ? "input--error" : "" %>" required />
            <%
              if (fieldErrors != null && fieldErrors.get("address") != null) {
            %>
            <div class="form__error"><%= HtmlUtil.escape(fieldErrors.get("address")) %></div>
            <%
              }
            %>
          </div>
          <div class="form__group">
            <label>ID Type</label>
            <input type="text" name="idType" placeholder="NIC/Passport" value="<%= isEdit ? (editGuest.getIdType() == null ? "" : HtmlUtil.escape(editGuest.getIdType())) : "" %>" />
          </div>
          <div class="form__group">
            <label>ID Number</label>
            <input type="text" name="idNumber" placeholder="ID Number" value="<%= isEdit ? (editGuest.getIdNumber() == null ? "" : HtmlUtil.escape(editGuest.getIdNumber())) : "" %>" />
            <%
              if (fieldErrors != null && fieldErrors.get("idNumber") != null) {
            %>
            <div class="form__error"><%= HtmlUtil.escape(fieldErrors.get("idNumber")) %></div>
            <%
              }
            %>
          </div>
          <div class="form__group">
            ...
            <input type="text" name="nationality" placeholder="Sri Lankan" value="<%= isEdit ? (editGuest.getNationality() == null ? "" : HtmlUtil.escape(editGuest.getNationality())) : "" %>" />
          </div>
          <div class="form__group">
            ...
            %>
            <div class="form__error"><%= HtmlUtil.escape(fieldErrors.get("guestType")) %></div>
            <%
              }
            %>
          </div>
      ...
      <div class="panel">
        ...
        <table class="table table--striped">
          ...
          <tbody>
            ...
            <tr>
              <td><%= guest.getId() %></td>
              <td><%= HtmlUtil.escape(guest.getFullName()) %></td>
              <td><%= HtmlUtil.escape(guest.getPhone()) %></td>
              <td><%= guest.getNationality() == null ? "-" : HtmlUtil.escape(guest.getNationality()) %></td>
              <td>
